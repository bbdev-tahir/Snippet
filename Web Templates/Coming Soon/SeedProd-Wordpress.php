...
*/
if(isset($_POST['notify_email']) && $_POST['notify_email'] && is_email($_POST['notify_email'] )){
	wp_mail($_POST['notify_email'], 'Notify Me', 'When your website will get launched, Please let me know on this Email '.$_POST['notify_email']);
	$update_message = 'Thanks for subscription, When our website will get launched then we will let you know.';
}
?>
<!DOCTYPE html>
<html class="cspio">
<head>
	...
	<?php
			$logo = '';
			//$logo = "https://static.comingsoonpage.com/cspio-assets/1.0.0/favicon.ico";
			$custom_logo_url = get_site_icon_url();
			if($custom_logo_url)
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			<?php
				$logo = '';
				//$logo = "https://static.comingsoonpage.com/cspio-assets/1.0.0/seedprod-logo-white.png";
				$custom_logo_id = get_theme_mod( 'custom_logo' );
				$custom_logo_url = wp_get_attachment_image_url( $custom_logo_id , 'full' );
				if($custom_logo_url)
					$logo = $custom_logo_url;
			?>
			<img id="cspio-logo" src="<?php echo $logo; ?>">
			    				
			<h1 id="cspio-headline"><?php echo get_the_title(); ?></h1>			    				
					...
					<div class="row">
						<div class="col-md-12 seperate">
							<div class="input-group">
								<input id="cspio-email" name="notify_email" class="form-control input-lg form-el" type="email" placeholder="Email" required/>
								<span class="input-group-btn"><button id="cspio-subscribe-btn" type="submit" class="btn btn-lg btn-primary form-el noglow">Notify Me</button></span>
							</div>
							<span style="font-size:13px;"><?php if(isset($update_message)){ echo $update_message; } ?></span>
						</div>
					</div>
				</div>
			</form>
			...
			<div id="cspio-credit">
					<span>Created by <a target="_blank" href="https://bytebunch.com">ByteBunch</a>
				</span></div>
