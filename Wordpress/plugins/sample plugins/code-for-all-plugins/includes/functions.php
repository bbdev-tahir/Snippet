...
if(!function_exists("BBWPUpdateErrorMessage")){
  function BBWPUpdateErrorMessage(){
    if(get_option('bbwp_update_message'))
      echo '<div class="updated settings-error notice is-dismissible"><p><strong>'.get_option('bbwp_update_message').'</strong></p></div>';
    elseif(get_option('bbwp_error_message'))
      echo '<div class="error settings-error notice is-dismissible"><p><strong>'.get_option('bbwp_error_message').'</strong></p></div>';
